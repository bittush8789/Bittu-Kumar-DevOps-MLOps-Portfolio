...
export const SKILLS = [
  ...
  {
    category: 'Monitoring & Languages',
    items: [
      { name: 'Prometheus', icon: 'Cpu' },
      { name: 'Grafana', icon: 'Layers' },

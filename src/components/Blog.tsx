...
export function Blog() {
  return (
    <section id="blog" className="py-20 md:py-32 relative overflow-hidden transition-all duration-500">
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-20">
          ...
          <a 
            ...
            className="px-10 py-4 glass-panel rounded-full text-[11px] font-black tracking-widest uppercase hover:bg-primary hover:text-black transition-all duration-300 flex items-center gap-4 border-white/5 shadow-xl"
          >
              ...
              <a href={post.link} target="_blank" rel="noopener noreferrer" className="block border-b border-white/5 py-10 md:py-14 group-hover:border-primary/40 transition-all duration-500">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 md:gap-10">
                  <div className="flex-grow">
                    <div className="flex items-center gap-4 md:gap-6 text-[9px] md:text-[10px] font-black tracking-[0.3em] uppercase text-neutral-500 mb-4 md:mb-6 group-hover:text-primary transition-colors duration-300">
                      <span className="flex items-center gap-2"><Calendar size={14} /> {post.date}</span>
                      <span className="w-1.5 h-1.5 rounded-full bg-primary/30" />
                      <span className="flex items-center gap-2"><Clock size={14} /> {post.readTime}</span>
                    </div>
                    <h4 className="text-2xl md:text-5xl font-black group-hover:text-primary transition-colors duration-300 mb-4 md:mb-6 leading-tight"> {post.title}</h4>
                  ...
                  <div className="shrink-0 hidden md:block">
                    ...
                    >
                      <ArrowRight size={32} className="text-neutral-500 group-hover:text-black transition-all duration-300 group-hover:scale-110" />
                    </div>
                  </div>
                </div>
              </a>
